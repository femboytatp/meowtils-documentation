...
!!! Note
    ...
    You should always use [RenderGameOverlayEvent](../rendergameoverlayevent) or [RenderWorldLastEvent](../renderworldlastevent) for render modules. It is recommended that you only use this event when you need to update something faster than what is possible with client tick.
